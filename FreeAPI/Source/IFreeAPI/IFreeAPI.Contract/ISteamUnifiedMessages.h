...
public:
	...
	virtual ClientUnifiedMessageHandle SendMethod(pCStrA pchServiceMethod, pCVoid pvRequestData, Uint32 nRequestDataSize, Uint64 nContext) = 0;
	...
	virtual Bool SendNotification(pCStrA pchServiceNotification, pCVoid pvDataNotificationData, Uint32 nNotificationDataSize) = 0;
