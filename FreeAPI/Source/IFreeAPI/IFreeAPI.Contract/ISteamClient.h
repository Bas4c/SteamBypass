...
public:
	...
	virtual IpSteamContentServer GetISteamContentServer(HSteamUser hSteamUser, HSteamPipe hSteamPipe, const pStrA pchVersion) = 0;
	virtual IpSteamMasterServerUpdater GetISteamMasterServerUpdater(HSteamUser hSteamUser, HSteamPipe hSteamPipe, const pStrA pchVersion) = 0;
