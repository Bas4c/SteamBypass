...
public:
	...
	ClientUnifiedMessageHandle SendMethod(pCStrA pchServiceMethod, pCVoid pvRequestData, Uint32 nRequestDataSize, Uint64 nContext) override;
	...
	Bool SendNotification(pCStrA pchServiceNotification, pCVoid pvDataNotificationData, Uint32 nNotificationDataSize) override;
