...
public:
	...
	void SendP2PRendezvous(SteamId_t SteamIdRemote, Uint32 ConnectionIdSrc, pCVoid pMsgRendezvous, Uint32 cbRendezvous) override;
	...
	void CacheRelayTicket(pCVoid pvTicket, Uint32 cbTicket) override;
	...
	void PostConnectionStateMsg(pCVoid pvMsg, Uint32 cbMsg) override;
