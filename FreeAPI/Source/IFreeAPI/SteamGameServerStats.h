...
public:
	...
	Bool SetUserStat(SteamId_t SteamIdUser, const pStrA pchName, Int32 Data) override;
	Bool SetUserStat(SteamId_t SteamIdUser, const pStrA pchName, Float Data) override;
	Bool UpdateUserAvgRateStat(SteamId_t SteamIdUser, const pStrA pchName, Float CountThisSession, Double SessionLength) override;
	
	Bool SetUserAchievement(SteamId_t SteamIdUser, const pStrA pchName) override;
	Bool ClearUserAchievement(SteamId_t SteamIdUser, const pStrA pchName) override;
