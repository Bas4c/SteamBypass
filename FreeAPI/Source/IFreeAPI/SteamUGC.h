...
public:
	...
	UGCQueryHandle_t CreateQueryAllUGCRequest(EUGCQuery eUGCQuery, EUGCMatchingUGCType eMatchingeMatchingUGCTypeFileType, AppId_t iCreatorAppId, AppId_t iConsumerAppId, pCStrA pchCursor) override;
	...
	Bool GetQueryUGCKeyValueTag(UGCQueryHandle_t hUGCQuery, Uint32 i, pCStrA pchKey, pStrA pchValue, Uint32 cchValueSize) override;
	...
	Bool AddRequiredTag(UGCQueryHandle_t hUGCQuery, pCStrA pTagName) override;
	Bool AddRequiredTagGroup(UGCQueryHandle_t hUGCQuery, const pSteamParamStringArray_t pTagGroups) override;
	Bool AddExcludedTag(UGCQueryHandle_t hUGCQuery, pCStrA pTagName) override;
	...
	Bool SetLanguage(UGCQueryHandle_t hUGCQuery, pCStrA pchLanguage) override;
	Bool SetAllowCachedResponse(UGCQueryHandle_t hUGCQuery, Uint32 nAgeSeconds) override;
	Bool SetCloudFileNameFilter(UGCQueryHandle_t hUGCQuery, pCStrA pMatchCloudFileName) override;
	Bool SetMatchAnyTag(UGCQueryHandle_t hUGCQuery, Bool bMatchAnyTag) override;
	Bool SetSearchText(UGCQueryHandle_t hUGCQuery, pCStrA pSearchText) override;
	...
	Bool AddRequiredKeyValueTag(UGCQueryHandle_t hUGCQuery, pCStrA pchKey, pCStrA pchValue) override;
	...
	Bool SetItemTitle(UGCUpdateHandle_t hUGCQuery, pCStrA pchTitle) override;
	Bool SetItemDescription(UGCUpdateHandle_t hUGCQuery, pCStrA pchDescription) override;
	Bool SetItemUpdateLanguage(UGCUpdateHandle_t hUGCQuery, pCStrA pchLanguage) override;
	...
	SteamAPICall_t SubmitItemUpdate(UGCUpdateHandle_t hUGCQuery, pCStrA pchChangeNote) override;
